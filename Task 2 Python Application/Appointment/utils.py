...
def unique_email_slug_Generator(instance, new_slug=None):
    ...
    if qs_exists:
        new_slug = "{slug}{randstr}".format(
            slug=slug,
            randstr=random.randint(00, 99)
        )
        return unique_email_slug_Generator(instance, new_slug=new_slug)
    return slug
...
def name__slug_generator(instance, new_slug=None):
    """
    This is for a Django project and it assumes your instance 
    has a model with a slug field and a title character (char) field.
    """
    ...
    if qs_exists:
        ...
        return name__slug_generator(instance, new_slug=new_slug)
    return slug
